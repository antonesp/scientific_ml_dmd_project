...
if __name__ == "__main__":
    ...
    full_field = full_field.at[~mask].set(jnp.real(mrDMD_result))  # plug DMD output back into valid locations
    ...
    im0 = ax[0].imshow(full_field)
    ax[0].set_title("Reconstruction")
    ax[0].axis("off")
    im1 = ax[1].imshow(true_field)
    ax[1].set_title("True")
    ax[1].axis("off")
    im2 = ax[2].imshow(full_field - true_field)
